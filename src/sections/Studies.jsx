...
import { studies, details } from "../constants";
  ...
  return (
    ...
    <Element name="features">
      <div className="container">
        <h3 className="h3 max-md:h5 text-p4">Case Studies</h3>
        <div className="relative flex  flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
          {studies.map(({ id, icon, caption, title, text, button }) => (
            <div
              key={id}
